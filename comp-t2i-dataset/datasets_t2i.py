...
class BaseDataset(data.Dataset):
    def __init__(self, data_dir, dataset_name, comp_type, split, subset="images",
        ...
        self.image_dir = os.path.join(data_dir, dataset_name, subset)
...
class WinogroundDataset(BaseDataset):
    ...
    def load_class_ids(self):
        # specify class_id_txt_path for multi instance learning
        # import pdb; pdb.set_trace()
        if self.class_id_txt_path is not None:
            image_id_to_class_id = {}
            with open(self.class_id_txt_path, "r") as f:
