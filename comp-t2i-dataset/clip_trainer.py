...
# preprocess data
hf_dataset = datasets.load_from_disk(TRAIN_DATA_DIR)
...
trainer = pl.Trainer(max_epochs=200, accelerator="gpu", auto_lr_find=True, 
    log_every_n_steps=5, logger=wandb_logger)   # limit_train_batches=1, logger=wandb_logger
